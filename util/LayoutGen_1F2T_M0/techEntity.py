...
class TechInfo:
    ...
    def update(self, isMaxCellWidthUpdate):
        ...
        if self.numTrack == 6:
            ...
            # print("[WARNING] Expected numTrack: 3, 4, 5, 6, but got %d" % self.numTrack)
            self.numFin = self.numTrack // 2 - 1
            # print("[WARNING] Set numFin to %d" % self.numFin)
    ...
    def initMultiHeight(self):
        ...
        for r in range(self.numTrack - 2):
            if self.numTrack - 2 == 2 * 6:
                ...
                return
        # print("routing_row_to_cell_row: ", self.routing_row_to_cell_row)
                    
        # self.placement_row_to_cell_row = {}
        # # print("[DEBUG] numTrack: ", self.numTrack)
        # for r in range(self.numTrack - 2):
        #     if self.numTrack - 2 == 2 * 6:
        #         if 0 <= r <= 2:
        #             self.placement_row_to_cell_row[r] = "NMOS_0"
        #         elif 3 <= r <= 5:
        #             self.placement_row_to_cell_row[r] = "PMOS_0"
        #         elif 6 <= r <= 8:
        #             self.placement_row_to_cell_row[r] = "PMOS_1"
        #         elif 9 <= r <= 11:
        #             self.placement_row_to_cell_row[r] = "NMOS_1"
        #     if self.numTrack - 2 == 2 * 5:
        #         if 0 <= r <= 2:
        #             self.placement_row_to_cell_row[r] = "NMOS_0"
        #         elif 3 <= r <= 4:
        #             self.placement_row_to_cell_row[r] = "PMOS_0"
