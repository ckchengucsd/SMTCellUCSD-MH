...
if len(sys.argv) > 21:
    multi_height_mode = True if int(sys.argv[21]) == 1 else False
    orderClip = sys.argv[22]
    print("multi_height_mode is provided {}.".format(sys.argv[21]))
else:
    print("multi_height_mode is not provided. Set to False.")
    multi_height_mode = False
...
print(f"   multi_height_mode: {multi_height_mode}")
print(f"   orderClip: {orderClip}")
