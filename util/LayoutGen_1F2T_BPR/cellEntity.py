...
class Metal:
    ...
    def getGdtStr(self, techInfo, isMarginApply):
        ...
        if techInfo.multi_height_mode:
            ...
            # check fromRow
            if techInfo.routing_row_to_cell_row[self.fromRow] == 1:
                yCoordMetalFrom = (
                    (
                        abs(techInfo.numFin * 2 - 1 - self.fromRow)
            ...
            elif techInfo.routing_row_to_cell_row[self.fromRow] == 0:
                yCoordMetalFrom = (
                    (
                        abs(techInfo.numFin * 2 - 1 - self.fromRow)
                        * techInfo.metal2Pitch
                ...
                exit(1)
            # check toRow
            if techInfo.routing_row_to_cell_row[self.toRow] == 1:
                yCoordMetalTo = (
                    (
                        abs(techInfo.numFin * 2 - 1 - self.toRow)
                        * techInfo.metal2Pitch
                        / 1000.0
            ...
            elif techInfo.routing_row_to_cell_row[self.toRow] == 0:
                yCoordMetalTo = (
                    (
                        abs(techInfo.numFin * 2 - 1 - self.toRow)
                        * techInfo.metal2Pitch
