...
public:
  ...
  void write_VR_AGR_M1_helper(float VR_M1M2_Parameter, int doublePowerRail,
                              FILE *drlog);
  void write_VR_AGR_M2_helper(float VR_M2M3_Parameter, int doublePowerRail,
                              FILE *drlog);
  ...
  // step 12
  void write_pin_access_rule(int M1_MPO_Parameter, int MAR_Parameter,
                             int EOL_Parameter, FILE *drlog);
  void write_pin_access_rule_helper(int M1_MPO_Parameter, int MAR_Parameter,
                                    int EOL_Parameter, FILE *drlog);
  void write_via_must_connect_upper_metal(FILE *drlog);
  void write_via_must_connect_lower_metal(FILE *drlog);
  ...
  void write_VR_Boundary_rule(float M2_ENC_Parameter);
};