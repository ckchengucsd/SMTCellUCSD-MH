...
public:
  ...
  void check_Partition_Parameter(int sizeOfPartition);

  void check_Placement_Parameter(int sizeOfPlacement);

  void check_Placement_and_Partition_Parameter(int sizeOfPlacement,
                                               int sizeOfPartition);

  void check_MH_Parameter();

  void setALLOW_LISD_EXTENSIBLE(int ALLOW_LISD_EXTENSIBLE) {
    ALLOW_LISD_EXTENSIBLE_ = ALLOW_LISD_EXTENSIBLE;
  }

  void setMIN_GATE_CUT_Parameter(int mingatecut) {
    MIN_GATE_CUT_Parameter_ = mingatecut;
  }

  void setAVOID_GCUT_ON_DUMMY(int avoidgcut) {
    AVOID_GCUT_ON_DUMMY_ = avoidgcut;
  }

  void setAVOID_CB_IN_MIDDLE_ROW(int avoidcb) {
    AVOID_CB_IN_MIDDLE_ROW_ = avoidcb;
  }

  void setGATE_PASSTHROUGH(int gatepassthrough) {
    GATE_PASSTHROUGH_ = gatepassthrough;
  }

  void setSD_PASSTHROUGH(int sdpassthrough) {
    SD_PASSTHROUGH_ = sdpassthrough;
  }

  void setZ3Seed(int Z3Seed) { Z3Seed_ = Z3Seed; }

  void setEEQ_Parameter(int EEQ_Parameter) { EEQ_Parameter_ = EEQ_Parameter; }
  ...
  void setM0_MPO_Parameter(int M0_MPO_Parameter) {
    M0_MPO_Parameter_ = M0_MPO_Parameter;
  }

  void setM1_MPO_Parameter(int M1_MPO_Parameter) {
    M1_MPO_Parameter_ = M1_MPO_Parameter;
  }
  ...
  void setPlacement_Parameter(int Placement_Parameter) {
    Placement_Parameter_ = Placement_Parameter;
  }
  ...
  int getEEQ_Parameter() { return EEQ_Parameter_; }

  int getALLOW_LISD_EXTENSIBLE() { return ALLOW_LISD_EXTENSIBLE_; }

  int getMin_GATE_CUT_Parameter() { return MIN_GATE_CUT_Parameter_; }

  int getAVOID_GCUT_ON_DUMMY() { return AVOID_GCUT_ON_DUMMY_; }

  int getAVOID_CB_IN_MIDDLE_ROW() {return AVOID_CB_IN_MIDDLE_ROW_;}
  
  int getGATE_PASSTHROUGH() { return GATE_PASSTHROUGH_; }

  int getSD_PASSTHROUGH() { return SD_PASSTHROUGH_; }
  ...
  int getPlacement_Parameter() { return Placement_Parameter_; }

  int getM0_MPO_Parameter() { return M0_MPO_Parameter_; }

  int getM1_MPO_Parameter() { return M1_MPO_Parameter_; }
...
private:
  ...
  int EEQ_Parameter_;
  // MultiHeight
  int MultiHeight_Parameter_;
  // Gate Cut Size
  int ALLOW_LISD_EXTENSIBLE_;
  int MIN_GATE_CUT_Parameter_;
  int AVOID_GCUT_ON_DUMMY_;
  int AVOID_CB_IN_MIDDLE_ROW_;
  int GATE_PASSTHROUGH_;
  int SD_PASSTHROUGH_;
  ...
  int M0_MPO_Parameter_;
  int M1_MPO_Parameter_;
