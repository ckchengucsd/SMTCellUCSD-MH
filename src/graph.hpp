...
public:
  void init_graph();
  void init_vertices(); // AGR version
  void init_udedges(); // AGR version
  void init_boundaryVertices(bool EXT_Parameter); // AGR version
  void init_source(bool SON);
  void init_outerPins();
  void init_pinSON(bool SON);
  void init_corner(); // AGR version
  void init_virtualEdges(); // AGR version
  void init_edgeIn();
  void init_edgeOut();
  void init_edgeInOut();
